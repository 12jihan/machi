...
Engine::Engine(const std::string& windowTitle, int windowWidth, int windowHeight) : title("MACHI - OPENGL TEST"), width(windowWidth), height(windowHeight), isInitialized(false), isRunning(false) {
...
void Engine::run() {
  ...
  while (isRunning && m_windowManager->shouldClose()) {
